...
public class Account {
    ...
    public Account(int id,String full_name,String email, String password, int type, boolean locked) {
    ...
    public Account(String email,String full_name, String password, int type, boolean locked) {
