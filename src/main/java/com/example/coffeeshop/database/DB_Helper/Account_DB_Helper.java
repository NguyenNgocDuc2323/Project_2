...
public class Account_DB_Helper {
    public static com.example.coffeeshop.model.Account getAccountByEmailAndPassword(String email, String password) {
        try(Connection conn = ConnectDatabase.getConnection();) {
            ...
            if (rs.next()) {
                ...
                return new com.example.coffeeshop.model.Account(id,name,result_email,result_password,type,lock_status);
            }
    ...
    public static void addAccount(com.example.coffeeshop.model.Account account) {
        try (Connection conn = ConnectDatabase.getConnection()) {
