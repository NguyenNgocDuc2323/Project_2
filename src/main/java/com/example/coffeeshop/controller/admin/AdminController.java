...
public class AdminController implements Initializable {
    ...
    void onAddAccount(ActionEvent event) {
        try {
            ...
            e.printStackTrace();
            System.err.println("Failed to navigate to Add New AccountDB screen.");
        }
    }
    ...
    void onLockAccount(ActionEvent event) {
        ...
        if (account == null) {
            ...
            alert.setTitle("No AccountDB Selected");
            ...
            if (result.get() == ButtonType.OK) {
                ...
                alert1.setContentText("AccountDB Locked");
                alert1.show();
                tbl_account.refresh();
            } else {
    ...
    void unLockAccount(ActionEvent event) {
        ...
        if (account == null) {
            ...
            if (result.get() == ButtonType.OK) {
                ...
                Alert alert1 = new Alert(Alert.AlertType.INFORMATION);
                alert1.setTitle("Confirmation Dialog");
                alert1.setContentText("AccountDB Unlocked");
                alert1.show();
                tbl_account.refresh();
            }
            else {
