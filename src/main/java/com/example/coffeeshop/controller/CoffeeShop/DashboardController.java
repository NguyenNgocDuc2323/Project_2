...
public class DashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        menuBtn.setOnAction(e -> loadView("/com/example/coffeeshop/view/CoffeeShop/MenuView.fxml"));
        cartBtn.setOnAction(e -> loadView("/com/example/coffeeshop/view/CoffeeShop/CartView.fxml"));
        historyBtn.setOnAction(e -> loadView("/com/example/coffeeshop/view/CoffeeShop/OrdersView.fxml"));
        profileBtn.setOnAction(e -> loadView("/com/example/coffeeshop/view/CoffeeShop/ProfileView.fxml"));

        // Load menu view by default
        loadView("/com/example/coffeeshop/view/CoffeeShop/MenuView.fxml");
