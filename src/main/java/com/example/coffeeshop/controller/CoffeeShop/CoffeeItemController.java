...
public class CoffeeItemController {
    ...
    private void loadCoffeeImage() {
        try {
            ...
            String resourcePath = "/com/example/coffeeshop/assets/images/CoffeeItem/" + imagePath;
            try {
            ...
            if (image == null || image.isError()) {
                try {
                    image = new Image(getClass().getResourceAsStream("/com/example/coffeeshop/assets/images/CoffeeItem/default.jpg"));
                } catch (Exception e) {
